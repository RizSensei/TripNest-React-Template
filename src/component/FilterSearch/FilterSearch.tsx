...
const FilterSearch = () => {
  ...
  const handleTravellingWithPetsToggle = () => {
    setTravellingWithPets(!travellingWithPets);
  };
        ...
        {isTravellerDropdown && (
          <div className="absolute top-[42px] z-10 w-full rounded-md border bg-white px-5 py-3 text-sm shadow">
            <div className="flex flex-col gap-2">
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    <input
                      ...
                      checked={travellingWithPets}
                      onChange={handleTravellingWithPetsToggle}
                    />
                  </label>
                </div>
              </div>
              ...
              <button
                onClick={() => setIsTravellerDropdown(!isTravellerDropdown)}
                className="bg-emerald rounded-md px-7 py-2 text-white"
              >
                Done
              </button>
            </div>
